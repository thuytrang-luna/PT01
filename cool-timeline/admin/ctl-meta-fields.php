...
if( class_exists( 'CTL' ) ) {
    ...
    // Create a metabox
    CTL::createMetabox( $pro_list, array(
       ...
       // Create a section
   CTL::createSection( $pro_list, array(
       //'title'  => 'Add Icon',
       'fields' => array(  
               array(
       ...
       $review_us = 'review_us';
       // Create a metabox
       CTL::createMetabox( $review_us, array(
          ...
          // Create a section
      CTL::createSection( $review_us, array(
       'fields' => array(  
           array(
